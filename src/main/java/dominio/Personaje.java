...
public abstract class Personaje extends PersonAbs implements Peleable, Serializable {
	 ...
	 * 
	 * @param nombreRaza
	 *            el el nombre de la raza del personaje
	 */
	 ...
	 * 
	 * @param ataque
	 *            son los puntos de ataque a setear
	 */
	 ...
	 * 
	 * @param magia
	 *            son los puntos de magia a setear
	 */
	 ...
	 * 
	 * @param clan
	 *            es el clan a cual pertenece el personaje
	 */
	 ...
	 * 
	 * @param energia
	 *            son los puntos de energia a setear
	 */
	 ...
	 * 
	 * @param fuerza
	 *            son los puntos de fuerza a setear
	 */
	 ...
	 * 
	 * @param destreza
	 *            son los puntos de destreza a setear
	 */
	 ...
	 * 
	 * @param inteligencia
	 *            son los punto de inteligencia a setear
	 */
	 ...
	 * 
	 * @param casta
	 *            es la casta a la que pertenece un personaje
	 */
	 ...
	 * 
	 * @param experiencia
	 *            son los puntos de experiencia de un personaje
	 */
	 ...
	 * 
	 * @param nivel
	 *            son los puntos de nivel de un personaje
	 */
	 ...
	 * 
	 * @param idPersonaje
	 *            es el identificador de un personaje
	 */
	 ...
	 * 
	 * @param defensa
	 *            son los puntos de defensa de un personaje
	 */
	 ...
	 * 
	 * @param saludTope
	 *            es el tope de salud de un personaje
	 */
	 ...
	 * 
	 * @param energiaTope
	 *            es el tope de energia de un personaje
	 */
	 ...
	 * 
	 * @param atacado
	 *            es el enemigo que recibira el ataque
	 */
	 ...
	 * 
	 * @param da�o
	 *            es la cantidad de puntos de da�os que el ataque le inflingio
	 *            al personaje
	 */
	 ...
	 * salud robada decrementa en función del nivel de defensa que posea el
	 * personaje.
	 * 
	 * @param daño
	 *            Cantidad recibida de daño por el personaje al cual se le roba
	 *            salud
	 ...
	 * 
	 * @param energia
	 *            energia que recupera Cantidad de energía por la cual el
	 *            personaje es energizado
	 */
	...
	/**
	 * Suma una determinada cantidad de experiencia al personaje y determinar si
	 * sube de nivel.
	 * 
	 * @param exp
	 *            esperiencia
	 * @return true/false Determina si subió o no de nivel como resultado de la
	 *         suma de experiencia
	 */
	...
	/**
	 * Permite calcular los tildes de distancia que hay entre este personaje y
	 * otro.
	 * 
	 * @param p
	 *            personaje respecto al cual quiero saber la distancia
	 * @return Math.sqrt(Math.pow(this.x - p.x, 2) + Math.pow(this.y - p.y,
	 *         2))Cantidad de tildes de distancia con respecto al otro personaje
	 */
	 ...
	 * @param atacado
	 *            peleable a atacar
	 * @return this.getCasta().habilidad1(this, atacado) Determina si se puede o
	 *         no realizar la habilidad
	 */
